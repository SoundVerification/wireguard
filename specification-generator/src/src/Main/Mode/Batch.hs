    ...
    setupFlags defaultMode = defaultMode
      ...
      , modeGroupFlags = Group
          { groupUnnamed =
              ...
              , flagNone ["tamigloo-compiler"] (addEmptyArg "tamiglooCompiler")
                  "Test whether tamigloo-compiler can be called"
...
run thisMode as
  ...
  where
    ...
    processThy inFile
      ...
      | argExists "tamiglooCompiler" as = 
          out (const Pretty.emptyDoc) tamiglooDebug (tamiglooMain as inFile)
      | argExists "diff" as =
